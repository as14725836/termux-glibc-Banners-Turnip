...
| **Commit** | [`61aaad5`](https://gitlab.freedesktop.org/mesa/mesa/-/commit/61aaad5a1add1bcea822c9ad8334dd52cb950254) |
| **Commit date** | 2026-07-21 |
| **Commit title** | virtio: magma-gpu-rs: add android to supported systems |
| **Build date** | 20260721 |
| **Release** | [v26.3.0-20260721-r6](https://github.com/as14725836/termux-glibc-Banners-Turnip/releases/tag/v26.3.0-20260721-r6) |
<!-- LATEST_BUILD_END -->
