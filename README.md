...
| **Commit** | [`ca0496b`](https://gitlab.freedesktop.org/mesa/mesa/-/commit/ca0496bc269400534f9a5679000d77085e1fefc3) |
| **Commit date** | 2026-05-27 |
| **Commit title** | radv: use load_deref_transpose_amd for transposed cooperative matrix loads |
| **Build date** | 20260527 |
| **Release** | [v26.2.0-20260527-r3](https://github.com/as14725836/termux-glibc-Banners-Turnip/releases/tag/v26.2.0-20260527-r3) |
<!-- LATEST_BUILD_END -->
