...
| **Commit** | [`503e8fe`](https://gitlab.freedesktop.org/mesa/mesa/-/commit/503e8fe6077474c912876c8298fc7b839d90ceba) |
| **Commit date** | 2026-09-18 |
| **Commit title** | nir/lower_input_attachments: add support for heap subpass image load |
| **Build date** | 20260918 |
| **Release** | [v26.3.0-20260918-r3](https://github.com/as14725836/termux-glibc-Banners-Turnip/releases/tag/v26.3.0-20260918-r3) |
<!-- LATEST_BUILD_END -->
